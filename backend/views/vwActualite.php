			...
			<div class="span12">
				<div class="btn-toolbar input-prepend">
					...
					<span class="add-on" style="margin-top: -9px; margin-right: -6px;"><i
						...
						type="text" placeholder="" id="date_actu">
				</div>
				<span class="span5 btn-toolbar btn-group" style="margin-left:  0">
				          ...
				          <ul class="dropdown-menu">
					            <li><a href="javascript: inbox.action('active')"><i class="icon-ok"></i> Marquer comme traité</a></li>
					            <li><a href="javascript: inbox.action('inactive')"><i class="icon-ban-circle"></i> Marquer comme non traité</a></li>
					             <li><a href="javascript: inbox.action('delete')"><i class="icon-trash"></i> Supprimer</a></li>
					           <!--  <li class="divider"></li>
				...
				<div class="widget widget-table action-table">
					<div class="widget-header">
						<i class="icon-file"></i>
						<h3>Boites de r&eacute;ception</h3>
					</div>
					<!-- /widget-header -->
						...
						<table class="table table-striped table-bordered" id="main-table">
							<thead>
								<tr>
									...
									<th style="width: auto;">District</th>
