								...
								<div class="tab-pane active" id="profile">
									...
									<form id="edit-profile" class="form-horizontal">
										...
										<fieldset>
											...
											<!-- /control-group -->
											<div class="control-group">
												<label class="control-label" for="firstname">Catégorie</label>
												<div class="controls">
													<select class="input-medium" id="categorie_idcategorie">
														<?php foreach($cat_produits as $cat):?>
														<option value="<?php echo $cat["idcat_produit"]?>"><?php echo $cat["nom_categorie"] ?></option>
														<?php endforeach?>
													</select>
												</div>
												<!-- /controls -->
